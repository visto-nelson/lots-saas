  ...
  return (
    <div className='h-60 bg-blue-800 mb-36 mt-20 md:mx-11  pt-10 px-8'>
      ...
      <div className='justify-center md:justify-end flex'>
        <div className='flex py-2.5 mr-4  px-4 rounded-sm text-sm bg-gray-100 placeholder:text-slate-400 text-black border border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1'><ForwardToInboxOutlinedIcon className=' stroke-slate-400'/><input className='pl-2 border-white bg-gray-100 focus:outline-none focus:border-none focus:ring-sky-500 focus:ring-none' placeholder='Enter your email' /></div>
